    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                ...
                'Stock Min': this.criteria.stockMin ? this.criteria.stockMin : environment.emptyForExport ,
                'Stock Max': this.criteria.stockMax ? this.criteria.stockMax : environment.emptyForExport ,
